...
function Cart() {
  ...
  useEffect(() => {
    ...
    cartItems.forEach((cartItem) => {
       // Remove commas and other non-numeric characters from the price
    const numericPrice = cartItem.price.replace(/\D/g, '');
    // Parse the cleaned price as an integer
      temp = temp + parseInt(numericPrice)
    })
    setTotalAmount(temp);
    // console.log(temp)
  }, [cartItems])
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_byd6h3AGo9vU9f",
      key_secret: "2pH3AgHcwxoeu9xokWejBowY",
